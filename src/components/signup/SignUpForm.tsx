...
const SignUpForm = () => {
    ...
    return (
        <main className="loginSignUp">
            ...
            <button className="loginSignUpBtn" onClick={(e)=>CheckAuthentication(e,email,emailCertification)}>인증번호 제출</button>
            ...
            <button className="loginSignUpBtn" onClick={(e=>submitSignUp(e,email,emailCertification,name,password,passwordCheck))}>회원가입하기</button>
            <GoogleOauth />
        </main>
    )
}
