...
const XtermQuestionAnswerInput:React.FC<XtermQuestionAnswerInputType> = ({answerType,submitQuestion}) => {
    ...
    return (
        <form className="ml-14 h-44">
            ...
            <button className="loginSignUpBtn mt-5" onClick={(e)=>{submitQuestion(inputValue,e)}}>정답 확인해보기</button>
        </form>
    )
}
