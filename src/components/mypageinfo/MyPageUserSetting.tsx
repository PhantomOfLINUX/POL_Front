        ...
        <div>
            ...
            </div>
            {
                ...
                (<div className="fixed flex justify-center items-center w-full max-h-screen z-0 top-0 left-0 right-0 bottom-0 bg-gray-500 bg-opacity-50" onClick={(e) => { e.preventDefault(); toggleModal() }}>
                    <div className="">
                        <div id="alert-additional-content-2" className="w-full p-4 mb-4 text-danger-800 border-2 border-danger-800 rounded-lg bg-danger-200 dark:bg-gray-800 dark:text-danger-400 dark:border-danger-800" role="alert">
